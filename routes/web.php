...
Route::group(['prefix' => 'websites'], function () {
    ...
    Route::get('/search', [WebsiteController::class, 'search'])->name('websites.search');
    //UserWise Functions
...
Route::group(['prefix' => 'orders', 'name' => 'orders.'], function () {
    ...
    Route::post('/{id}/add_to_cart/{website_id}/{rate_id}', [OrderController::class, 'add_to_cart'])->name('orders.add_to_cart');
    ...
    Route::post('/delete-item', [OrderController::class, 'deleteItem'])->name('cart.delete');
...
//     return view('layouts.cart.add-to-cart');
// });

// Route::get('/add-to-cart',[CartController::class,'index'])->name('add.index');
// Route::post('/cart/store',[CartController::class,'addToCart'])->name('add.store');
