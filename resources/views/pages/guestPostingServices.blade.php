...
<div class="main contPlains tac" id="pricing">
    ...
    <div class="plains">
        <div class="plain" id="cardPlain">
            <div class="card">
                ...
                <a href="{{ route('plan-basic') }}"><button class="btnP btnB" id="btnB">
                    Buy Now
                </button></a>
            </div>
        </div>
        <div class="plain" id="cardPlain2">
            <div class="card">
                ...
                <a href="{{ route('plan-standard') }}"><button class="btnP btnB" id="btnB">
                        Buy Now
                    </button></a>
            </div>
        </div>
        <div class="plain" id="cardPlain3">
            <div class="card">
                ...
                <a href="{{ route('plan-premium') }}"><button class="btnP btnB" id="btnB">
                        Buy Now
                    </button></a>
            </div>
        </div>
    ...
    <div class="bgp">
        ...
        <div class="proBgp">
            ...
            <a class="btn" href="{{ route('marketplace') }}">
                Buy Guest Posts
            </a>
        </div>
    </div>
