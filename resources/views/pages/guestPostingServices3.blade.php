...
<div class="main contPlains tac" id="pricing">
    ...
    <div class="plains">
        <div class="plain" id="cardPlain">
            <div class="card">
                ...
                <a class="btnP btnB" href="{{ route('plan-basico') }}" style="cursor: pointer;">
                    Buy Now
                </a>
            </div>
        </div>
        <div class="plain" id="cardPlain2">
            <div class="card">
                ...
                <a class="btnP btnB" href="{{ route('plan-standard') }}" style="cursor: pointer;">
                    Buy Now
                </a>
            </div>
        </div>
        <div class="plain" id="cardPlain3">
            <div class="card">
                ...
                <a class="btnP btnB" href="{{ route('plan-premium') }}" style="cursor: pointer;">
                    Buy Now
                </a>
            </div>
        </div>
    ...
    <div class="bgp">
        ...
        <div class="proBgp">
            ...
            <a class="btn" href="{{ route('pages.marketplace') }}">
                Buy Guest Posts
            </a>
        </div>
    </div>
