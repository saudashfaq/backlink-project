                                ...
                                <form id="form-payment" action="{{ route('payWithPayPal') }}" method="post">
                                    ...
                                    <table class="table table-bordered cart-table">
                                        ...
                                        <tr id="payOpPayoneer">
                                            <td>
                                                <label class="payment-option">
                                                    <input type="radio" value="stripe" class="add_money_using_payoneer" name="method" id="radioStripe"> <a href="javascript:void(0)" class="add_money_using_payoneer"><img height="40" src="{{ asset('img/stripe.png') }}"></a>
                                                </label>
                                            </td>
                                        </tr>
                                        </tbody></table>
                    ...
                    <div class=" row cart-step cartsec" style="display: flex;">
                        ...
                        <div class="col-md-9 ">
                            ...
                            @endphp
                                ...
                                <div class="scrollBox">
                                    <div class="checkoutBox" id="checkout-button">
                                        <form id="payment-form" action="{{ route('stripe.createCheckoutSession') }}" method="POST">
                                            @csrf
                                            <input type="hidden" name="seller_id" value="{{ $seller_id }}">
                                            <input type="hidden" name="website_id" value="{{ $website_id }}">
                                            <input type="hidden" name="total" value="{{ $total }}">
                                            <button type="submit"  id="placeOrder" class="btn-span-checkout cart-btn">Go to checkout</button>
                                        </form>
                                    <!--<span class="btn-span-checkout cart-btn" id="btnGoCheckout">-->

{{--                                        <a href="{{ route('stripe.createCheckoutSession',$total) }}" class="btn-span-checkout cart-btn" id="{{$total}}">Go to checkout</a>--}}
