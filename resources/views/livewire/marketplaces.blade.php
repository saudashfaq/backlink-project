...
<header class="main header" id="fean">
    ...
    <div class="row" style="width: 100%">
        ...
        <div class="col-12 header" style="border-bottom: 0">
            <h2 class="titleMp">
                Marketplace
            </h2>
            <form class="search">
            ...
            <div>
                <table class="table">
                    <tbody class="bodyT">
                        ...
                        <tr class="tr">
                            <td>
                            	<input type="text" name="wbname{{ (string)$counter }}" value="{{ $websiteTop->web_name }}" id="wbname{{ (string)$counter }}" style="display: none;">
                            	{{ $websiteTop->web_name }}
                            </td>
                            <td>{{ $websiteTop->da }}</td>
                            <td>{{ $websiteTop->pa }}</td>
                            ...
                            <td>
                                <a href="{{ route('cart.add', $websiteTop->web_id) }}"  class="btnT"  id="enlace">Add to cart</a>
                            </td>
                        </tr>
                        @php
                            $counter = $counter + 1;
                ...
                <table class="table">
                    <tbody class="bodyT">
                        ...
                        <tr class="tr">
                            ...
                            <td>
                                <a href="{{ route('cart.add', $websiteRecommend->web_id) }}"  class="btnT"  id="enlace">Add to cart</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
                ...
                <table class="table">
                    <tbody class="bodyT">
                        ...
                        <tr class="tr">
                            ...
                            <td>
                                <a href="{{ route('cart.add', $websiteHigh->web_id) }}"  class="btnT"  id="enlace">Add to cart</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
...
document.addEventListener('click', (e) => {
			if (e.target.matches('button')) {
				...
				let wbname = e.target.parentElement.previousElementSibling.previousElementSibling.previousElementSibling.previousElementSibling.previousElementSibling.firstElementChild.value;

				console.log(wbname)

                console.log(e.target.parentElement.previousElementSibling.previousElementSibling.previousElementSibling.previousElementSibling.previousElementSibling.firstElementChild.id);

				let td = e.target.parentElement;

				window.livewire.emit('wbname', wbname);
