                ...
                <div class="col-md-4">
                    <table class="table table-bordered text-center">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <span class="card-big-text">{{$activeOrders}}</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-bordered text-center">
                        <tbody>
                            <tr>
                                <th class="my-top-bar">
                                    Total Websites
                                    <a href="{{route('publisher.websites')}}" style="color: yellow !important; float: right;">Details</a>
                                </th>
                            </tr>
                            <tr>
                                <td>
                                    <span class="card-big-text">{{$websitesCount}}</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
